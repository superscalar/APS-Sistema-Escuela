  ...
  return (
    <section className="mt-4 flex flex-col items-center justify-center">
	  ...
	  <Link href="#" className="bg-gray-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
		...
		<Link href="/docencia/calificaciones" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          <div className="flex items-center justify-center">
            Calificaciones
          </div>
        </Link>
		...
		<Link href="/docencia/amonestaciones" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          <div className="flex items-center justify-center">
